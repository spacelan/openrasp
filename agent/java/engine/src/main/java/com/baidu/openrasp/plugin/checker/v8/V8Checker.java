...
public class V8Checker extends AttackChecker {
    ...
    //     System.out.println(checkParameter.getType().name());
    //     System.out.flush();
    ...
    //     JsonStream.serialize(new Object(), context);
    //     System.out.println("222222222222222222222222222222222>");
    //     return V8.Check(checkParameter.getType().name().toLowerCase(), params.getByteArray(), params.size(), context.getByteArray(), context.size());
    // }
